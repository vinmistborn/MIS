        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseDuration = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupTime", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IncreaseFeeBy = table.Column<decimal>(type: "decimal(3,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    NumOfStudents = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastLesson = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentGroupHistory", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentGroupHistory_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StudentGroupHistory_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentGroupHistory_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExpensesLogs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Income_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Income_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IncomeLogs_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_IncomeLogs_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupTimeId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Timetable_GroupTime_GroupTimeId",
                        column: x => x.GroupTimeId,
                        principalTable: "GroupTime",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Timetable_LessonDays_LessonDayId",
                        column: x => x.LessonDayId,
                        principalTable: "LessonDays",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Timetable_Rooms_RoomId",
                        column: x => x.RoomId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TotalCashFlow", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DoB = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EmployeeStatus = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
                    BranchId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupTeacher_Users_TeacherId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Income_GroupId",
                table: "Income",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_Income_StudentId",
                table: "Income",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_IncomeLogs_BranchId",
                table: "IncomeLogs",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_IncomeLogs_GroupId",
                table: "IncomeLogs",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_IncomeLogs_StudentId",
                table: "IncomeLogs",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentGroupHistory_CourseId",
                table: "StudentGroupHistory",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentGroupHistory_GroupId",
                table: "StudentGroupHistory",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentGroupHistory_StudentId",
                table: "StudentGroupHistory",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Timetable_GroupTimeId",
                table: "Timetable",
                column: "GroupTimeId");

            migrationBuilder.CreateIndex(
                name: "IX_Timetable_LessonDayId",
                table: "Timetable",
                column: "LessonDayId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TotalCashFlow_BranchId",
                table: "TotalCashFlow",
                column: "BranchId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ExpensesLogs_Branches_BranchId",
                table: "ExpensesLogs",
                column: "BranchId",
                principalTable: "Branches",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_IncomeLogs_Branches_BranchId",
                table: "IncomeLogs",
                column: "BranchId",
                principalTable: "Branches",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_TotalCashFlow_Branches_BranchId",
                table: "TotalCashFlow",
                column: "BranchId",
                principalTable: "Branches",
                principalColumn: "Id",
